// LeetCode Question 375.Guess Number Higher Or Lower ||.
#include<iostream>
#include<vector>
using namespace std;
...
int main(){
    ...
    int ans1 = solveUsingRecursion(start, end);
    cout<<"The Minimum Amount Of Money By Using Recurtion : "<<ans1<<endl;

    int ans2 = solveUsingMem(start, end, dp);
    cout<<"The Minimum Amount Of Money By Using Mem : "<<ans2<<endl;

    int ans3 = solveUsingTabulation(n);
    cout<<"The Minimum Amount Of Money By Using Tabulation : "<<ans3<<endl;
